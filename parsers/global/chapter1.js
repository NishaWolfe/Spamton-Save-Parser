...
function ParseThrashMachine(flagArray){
  flagArray[220] = {
...
function ParseNewhomeCh1(flagArray){
...
function ParseOtherCh1(flagArray){
...
function ParseChapter1GlobalFlags(flagArray){
  return new Promise((resolve,reject)=>{
    ParseFlags(flagArray);
    ParseThrashMachine(flagArray);
    ParseNewhomeCh1(flagArray);
    ParseOtherCh1(flagArray);
    ParseGoner(flagArray);
...
module.exports = ParseChapter1GlobalFlags;